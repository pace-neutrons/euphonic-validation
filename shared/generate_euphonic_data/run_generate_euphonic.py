...
for temp in quartz_temps:
    for cut in quartz_cuts:
        ...
        sf_main(['../../quartz/' + cut + '/', '--dw', '../../quartz/shared/euphonic/dw_fc_666_' + temp + 'K.json', '--freqs'])
...
for temp in lzo_temps:
    for cut in lzo_cuts:
        ...
        sf_main(['../../lzo/' + cut + '/', '--dw', '../../lzo/shared/euphonic/dw_fc_666_' + temp + 'K.json', '--freqs'])
...
for temp in nb_temps:
    for cut in nb_cuts:
        ...
        sf_main(['../../nb/' + cut + '/', '--dw', '../../nb/shared/euphonic/dw_fc_666_' + temp + 'K.json', '--freqs'])
