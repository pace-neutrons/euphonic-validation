...
def get_fig(material, cut, x_data_idx=None, **plot_kwargs):
...
fig1 = get_fig('quartz', '30L_qe_fine', 2, ratio=0.6, vmax=1e-11,
               x_label='[3,0,L]')
fig2 = get_fig('quartz', '2ph_m4_0_qe', 0, vmax=1e-11,
               x_label='[H,-4,0]')
fig3 = get_fig('lzo', 'kagome_qe', 2, ratio=0.6, vmax=1e-9,
               x_label='[5,7,L]')
fig4 = get_fig('lzo', 'hh2_qe_fine', 0, ratio=0.6, vmax=1e-11,
               x_label='[H,H,-2]')
fig5 = get_fig('nb', '110_qe', 0, ratio=0.6, vmax=1e-11,
               x_label='[H,H,0]')
fig6 = get_fig('nb', 'm110_qe', 0, ratio=0.6, vmax=1e-11,
               x_label='[H,-H,0]')
